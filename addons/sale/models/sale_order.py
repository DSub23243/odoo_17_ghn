...
class SaleOrder(models.Model):
    ...
    # diary_ids = fields.One2many(comodel_name="diary.order", string="Diary", inverse_name='oder_ids')
    ...
    def action_confirm(self):
        ...
        """
        # for order in self:
        #     if order.amount_total > order.partner_id.limit_credit:
        #         raise UserError(
        #             _("The total bill order is higher than the credit limit for this customer: %s" % order.partner_id.limit_credit))
