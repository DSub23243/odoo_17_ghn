...
class StockPicking(models.Model):
    ...
    sale_id = fields.Many2one(related="group_id.sale_id", string="Sales Order", store=False, readonly=False)
    ...
    def ghn_cancel_order(self):
        request_url = "https://dev-online-gateway.ghn.vn/shiip/public-api/v2/switch-status/cancel"
